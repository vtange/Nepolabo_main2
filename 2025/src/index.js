...
var timeOfDayClass = time > 6 ? (time > 19 ? "night" : (time < 16 ? "" : "dusk")) : "night";
var bg = document.getElementById('bg');
if(timeOfDayClass){
    bg.classList.add(timeOfDayClass);
    document.querySelector(".projects-container").classList.add(timeOfDayClass);
}
